...
urlpatterns = [
    ...
    url(r'^membership-plans/', account_views.PricePlanListView.as_view(), name='membership-plans'),
    url(r'^(?:plan_name=(?P<plan_name>\w+))', account_views.setPrefPlan, name='plan-definition'),
    url(r'^upgrade-plan/(?:plan_name=(?P<plan_name>\w+))', account_views.upgradeOrSetPlan, name='upgrade-plan'),
    url(r'^about-us/', account_views.aboutUs, name='about'),
